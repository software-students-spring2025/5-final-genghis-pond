...
terms["allowed_country_list"] = terms["allowed_countries"].apply(
...
taxon_subset = combine_terms[
    ["dwc:scientificName", "dwc:scientificNameAuthorship"]
].copy()
...
combine_terms["scientificName_cleaned"] = (
    combine_terms["scientificName_cleaned"]
    .str.encode("latin1", errors="ignore")
    .str.decode("utf-8", errors="ignore")
)
combine_terms["scientificName_cleaned"] = combine_terms[
    "scientificName_cleaned"
].str.lower()
...
full_data = pd.merge(
    ...
    right_on="scientificName_cleaned",
    how="outer",
)
print(len(full_data))

full_data["final_scientific_name"] = full_data["scientific_name"].fillna(
    full_data["scientificName_cleaned"]
)
full_data["common_name"] = full_data["dwc:vernacularName"].fillna(
    full_data["final_scientific_name"]
)
